            ...
            <div class="row">
                <div class="col-12 col-md-6 pt-5 pe-md-4">
                    ...
                    <div class="d-flex flex-column flex-md-row w-100 mb-4">
                        <a href="" class="btn btn-light w-100 mb-2 mb-md-0 me-md-2"><img class="me-3" src="{{asset('assets/img/logo_google.png')}}" alt="logo Google">Google</a>
                        <a href="" class="btn btn-light w-100"><img class="me-3" src="{{asset('assets/img/logo_facebook.png')}}" alt="logo Facebook">Facebook</a>
                    </div>
                    <div class="">
                        Belum Punya Akun ? <a href="" style="color: #95de64">Daftar</a>
                    </div>
                </div>
